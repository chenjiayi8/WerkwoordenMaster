...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 12 14:14:56 2020

@author: Nitesh Kumar
@URL: https://linuxhint.com/how-to-write-a-simple-text-editor-in-pyqt5/
"""
...
class Window(QWidget):
    ...
    def save_current_file(self):
        if not self.file_path:
            new_file_path, filter_type = QFileDialog.getSaveFileName(self,\
             "Save this file as...", "", "All files (*)")
            if new_file_path:
    ...
    def invalid_path_alert_message(self):
        ...
        messageBox.setText(("Selected filename or path is not valid. "
