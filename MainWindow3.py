...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBoxRangeType = QtWidgets.QComboBox(self.centralwidget)
        self.comboBoxRangeType.setObjectName("comboBoxRangeType")
        self.horizontalLayout_2.addWidget(self.comboBoxRangeType)
        ...
        self.comboBoxRangeStart.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        ...
        self.comboBoxRangeEnd.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        ...
        self.buttonQuit1 = QtWidgets.QPushButton(self.centralwidget)
        self.buttonQuit1.setObjectName("buttonQuit1")
        self.horizontalLayout_4.addWidget(self.buttonQuit1)
        ...
        self.textEditNote = QtWidgets.QTextEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.textEditNote.setFont(font)
        self.textEditNote.setObjectName("textEditNote")
        self.verticalLayout.addWidget(self.textEditNote)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.pushButtonNoteNew = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonNoteNew.setObjectName("pushButtonNoteNew")
        self.horizontalLayout_5.addWidget(self.pushButtonNoteNew)
        self.pushButtonNoteOpen = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonNoteOpen.setObjectName("pushButtonNoteOpen")
        self.horizontalLayout_5.addWidget(self.pushButtonNoteOpen)
        self.pushButtonNoteSave = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonNoteSave.setObjectName("pushButtonNoteSave")
        self.horizontalLayout_5.addWidget(self.pushButtonNoteSave)
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem4)
        self.buttonQuit2 = QtWidgets.QPushButton(self.centralwidget)
        self.buttonQuit2.setObjectName("buttonQuit2")
        self.horizontalLayout_5.addWidget(self.buttonQuit2)
...
"(b)Ctrl+Enter to input multiply lines"))
        ...
        self.buttonQuit1.setToolTip(_translate("MainWindow", "Exit the app"))
        self.buttonQuit1.setText(_translate("MainWindow", "Quit"))
        self.checkBox.setText(_translate("MainWindow", "Note:"))
        self.pushButtonNoteNew.setText(_translate("MainWindow", "New"))
        self.pushButtonNoteOpen.setText(_translate("MainWindow", "Open"))
        self.pushButtonNoteSave.setText(_translate("MainWindow", "Save"))
        self.buttonQuit2.setText(_translate("MainWindow", "Quit"))
